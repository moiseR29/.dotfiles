...
group_configure = [
    ...
    ("4", { 'label': '', 'layout': 'max', 'matches': [Match(wm_class=["brave-browser"])] }),
    ("5", { 'label': '', 'layout': 'max', 'matches': [] }),
    ("6", { 'label': 'ﭮ', 'layout': 'max', 'matches': [Match(wm_class=["discord", "slack"])] })
]
...
primaryScreenBar = [
        # Ubuntu Log Section
        icon(bg='color1',fg='dark', fontsize=35, text=""),
        separator(),
...
commandsToExecuteWhenStart = [
    ...
    "feh --bg-center ~/Imagenes/mclarenBosque.jpg",
